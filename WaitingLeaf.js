...
export default class LoginLeaf extends Component<Props> {
  ...
  userPressConfirm () {
    console.log('eeee ');
    this.this.props.navigator.push({
  ...
  render() {
    return (
      <View style={styles.container}>
        ...
        />
        <Text style={styles.bigTextStyle} onprogress={()=>this.userPressConfirm()}>
        确定
        </Text>
        <Text style={styles.bigTextStyle} onprogress={()=>this.userPressAddressBook()}>
        通讯录
        </Text>
      </View>
    );
